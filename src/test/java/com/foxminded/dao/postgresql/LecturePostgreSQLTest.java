...
class LecturePostgreSQLTest {
    ...
    public LectureDAO lectureDAO = (LecturePostgreSQL) context.getBean("lecturePostgreSQL");
    public ClassRoomDAO classRoomDAO = (ClassRoomPostgreSQL) context.getBean("classRoomPostgreSQL");
